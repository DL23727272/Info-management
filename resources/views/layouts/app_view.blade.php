...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="{{asset('/images/ispsctext.png')}}"/>
...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo me-5" href="/"> <img src="{{ asset('images/auth/ispsctext.png') }}" alt="logo"/></a> <!--- SYSTEM LOGO ---->
            <a class="navbar-brand brand-logo-mini" href="/"><img src="{{ asset('images/auth/ispsctext.png') }}" alt="logo"/></a>
        </div>
...
<footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">dl</span>
    </div>
</footer>
<!-- partial -->
